...
### Problema 05: Un lote de N=400 productos industriales contiene 160 defectuosos. Sea Y el número de defectuosos en una muestra aleatoria de tamaño 20:

* Encuentra p(10) con el uso de (a) la distribución de probabilidad hipergeométrica.
* Encuentra p(10) la distribución de probabilidad binomial.
* Es N suficientemente grande para que el valor p(10) obtenido con la binomial sea una buena aproximación de la obtenida por la hipergeométrica?
...
Podemos ver cómo, tanto  con la prueba comparativa con la p(10) como la prueba con Ji-cuadrada, se puede aceptar a la Binomial como una aproximación aceptable para este caso particular. En general, se conoce que cuando la aproximación n/N es ~ 10% entonces se tiene una buena aproximación. En general, cuando se tiene un N >> n, la aproximación es excelente. Además, podemos comprobar por el gráfico como es que ambas distribuciones se ven bien, quedando casi empalmadas. No hay mucha diferencia. 